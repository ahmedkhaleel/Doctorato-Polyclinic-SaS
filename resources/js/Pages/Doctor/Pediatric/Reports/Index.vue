    ...
    <div class="px-4 sm:px-6 pb-10">
        ...
        >
            ...
            >
                ...
                <button @click="showToast = false" class="flex-shrink-0 ms-2 text-gray-400 hover:text-white transition-colors" :aria-label="isRtl ? 'إغلاق' : 'Close'" :title="isRtl ? 'إغلاق' : 'Close'">
