...
function submit() { form.post('/secretary/forgot-password', { preserveScroll: true }); }
</script>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl p-7">
                ...
                <div class="mt-6 text-center">
                    <Link href="/secretary/login" class="text-sm text-gray-400 hover:text-[#C4A265]">← {{ isRtl ? 'العودة لتسجيل الدخول' : 'Back to login' }}</Link>
                </div>
            </div>
        </div>
    </div>
