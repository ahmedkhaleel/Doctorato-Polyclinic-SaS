...
<template>
    <AdminLayout :title="$t('a_add_slide')">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-xl md:text-2xl font-bold text-gray-800">{{ $t('a_add_slide') }}</h1>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        >
                            ...
                            <label v-else class="flex flex-col items-center justify-center py-8 cursor-pointer">
                                ...
                                <span class="text-sm text-gray-500">{{ $t('a_click_to_upload') }}</span>
                                <span class="text-xs text-gray-400 mt-1">{{ $t('a_recommended_size') }}</span>
                    ...
                    <div class="flex space-x-3">
                        ...
                        >
                            {{ form.processing ? $t('a_saving') : $t('a_create_slide') }}
                        </button>
                        <Link href="/admin/slider" class="px-4 py-2.5 rounded-lg bg-gray-200 text-gray-700 text-sm font-medium hover:bg-gray-300 transition">
                            {{ $t('a_cancel') }}
                        </Link>
                    </div>
                </div>
