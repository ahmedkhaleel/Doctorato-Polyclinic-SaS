...
<template>
    <AdminLayout :title="$t('a_edit_post')">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-xl md:text-2xl font-bold text-gray-800">{{ $t('a_edit_post') }}</h1>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input v-model="form.title_en" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" />
                        ...
                        <div>
                            ...
                            <input v-model="form.title_ar" type="text" dir="rtl" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" />
                        ...
                        <div>
                            ...
                            <input v-model="form.slug" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm bg-gray-50 focus:ring-2 focus:ring-amber-200 focus:border-transparent" />
                        ...
                        <div>
                            ...
                            <textarea v-model="form.excerpt_en" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent"></textarea>
                        ...
                        <div>
                            ...
                            <textarea v-model="form.excerpt_ar" rows="2" dir="rtl" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent"></textarea>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input v-model="form.published_at" type="datetime-local" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" />
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        <div>
                            <select v-model="form.category_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        <div>
                            <div v-if="post.featured_image" class="mb-3">
                                <img :src="`/storage/${post.featured_image}`" alt="Current image" class="w-full h-32 object-cover rounded-lg" />
                            </div>
                            <input
                                type="file"
                                accept="image/*"
                    ...
                    <div class="flex space-x-3">
                        ...
                        >
                            {{ form.processing ? $t('a_saving') : $t('a_update_post') }}
                        </button>
