...
const colorMaps = {
    visit: {
        waiting: { classes: 'bg-yellow-100 text-yellow-800', label: 'Waiting' },
        in_progress: { classes: 'bg-blue-100 text-blue-800', label: 'In Progress' },
    ...
    invoice: {
        ...
        partial: { classes: 'bg-yellow-100 text-yellow-800', label: 'Partial' },
    ...
    package: {
        ...
        completed: { classes: 'bg-blue-100 text-blue-800', label: 'Completed' },
        cancelled: { classes: 'bg-red-100 text-red-800', label: 'Cancelled' },
    },
    leave: {
    ...
    booking: {
        new: { classes: 'bg-blue-100 text-blue-800', label: 'New' },
        contacted: { classes: 'bg-yellow-100 text-yellow-800', label: 'Contacted' },
        confirmed: { classes: 'bg-green-100 text-green-800', label: 'Confirmed' },
