...
function statusBadge(status) {
    const map = {
        ...
        missed_patient: { bg: 'bg-orange-50', text: 'text-orange-600', label: isRtl.value ? 'فوّت المريض' : 'Missed' },
        missed_doctor: { bg: 'bg-orange-50', text: 'text-orange-600', label: isRtl.value ? 'فوّت الطبيب' : 'Missed' },
