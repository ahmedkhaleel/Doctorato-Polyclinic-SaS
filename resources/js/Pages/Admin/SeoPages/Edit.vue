    ...
    <AdminLayout :title="$t('a_edit_seo')">
        <div class="space-y-6 max-w-5xl">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-xl md:text-2xl font-bold text-gray-800">{{ $t('a_edit_seo') }} — {{ seoPage.page_name_en }}</h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input v-model="form.title_en" type="text" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" placeholder="Page title for search engines" />
                        ...
                        <div>
                            ...
                            <input v-model="form.title_ar" type="text" dir="rtl" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" placeholder="عنوان الصفحة لمحركات البحث" />
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <textarea v-model="form.description_en" rows="3" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" placeholder="Brief description shown in search results"></textarea>
                        ...
                        <div>
                            ...
                            <textarea v-model="form.description_ar" rows="3" dir="rtl" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" placeholder="وصف مختصر يظهر في نتائج البحث"></textarea>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input v-model="form.keywords" type="text" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" placeholder="keyword1, keyword2, keyword3" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input v-model="form.og_image" type="text" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" placeholder="/images/og-home.jpg" />
                        ...
                        <div>
                            ...
                            <input v-model="form.canonical_url" type="text" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" placeholder="https://doctorato.com/page" />
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 space-y-5">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <button
                            ...
                            class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-amber-300 focus:ring-offset-2"
