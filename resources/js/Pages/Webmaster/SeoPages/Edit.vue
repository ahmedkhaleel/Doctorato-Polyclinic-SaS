...
function submit() {
    form.post(`/webmaster/seo-pages/${props.seoPage.id}/update`);
}
...
<template>
    <WebmasterLayout title="Edit SEO">
        <div class="space-y-6 max-w-5xl">
            <!-- Header -->
            <div class="flex items-center gap-4">
                <Link href="/webmaster/seo-pages" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                    Back
                </Link>
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Edit SEO — {{ seoPage.page_name_en }}</h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
                    <h2 class="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-3">{{ $t('a_page_title') }}</h2>
                ...
                <!-- Description -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
                    <h2 class="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-3">{{ $t('a_meta_description') }}</h2>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div>
                            <p class="text-sm font-medium text-gray-700">Allow Search Engine Indexing</p>
                            <p class="text-xs text-gray-500 mt-0.5">When disabled, search engines will not index this page (noindex, nofollow)</p>
                        </div>
                        <button
                            type="button"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <Link href="/webmaster/seo-pages" class="text-sm text-gray-500 hover:text-gray-700">{{ $t('a_cancel') }}</Link>
                </div>
            </form>
        </div>
    </WebmasterLayout>
