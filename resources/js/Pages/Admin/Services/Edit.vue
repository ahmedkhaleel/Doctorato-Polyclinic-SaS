...
const form = useForm({
    module: props.service.module || 'derma',
    ...
    price_after_discount: props.service.price_after_discount || '',
    supply_cost: props.service.supply_cost || '',
    medical_fee: props.service.medical_fee || '',
    default_sessions: props.service.default_sessions || '',
    session_duration_minutes: props.service.session_duration_minutes || '',
    clinic_notes: props.service.clinic_notes || '',
    _method: 'PUT',
});
...
<template>
    <AdminLayout :title="$t('a_edit_service')">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-xl md:text-2xl font-bold text-gray-800">{{ $t('a_edit_service') }}</h1>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <textarea v-model="form.benefits_ar" rows="4" dir="rtl" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input v-model="form.seo_keywords" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-200 focus:border-transparent" />
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        />
                        <p class="text-xs text-gray-400">{{ $t('a_leave_empty_keep_current') }}</p>
