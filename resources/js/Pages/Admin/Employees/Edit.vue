    ...
    <AdminLayout :title="`${$t('a_edit_employee')}: ${employee.user?.name}`">
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">{{ $t('a_edit_employee') }}: {{ employee.user?.name }}</h1>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 space-y-3">
                        ...
                        <Link
                            ...
                            class="block w-full text-center px-6 py-3 rounded-lg border border-gray-300 text-gray-600 font-medium text-sm hover:bg-gray-50 transition"
                        >
                            {{ $t('a_cancel') }}
                        </Link>
                    </div>
