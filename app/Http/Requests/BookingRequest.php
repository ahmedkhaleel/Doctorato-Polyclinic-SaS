...
class BookingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'booking_type'    => ['required', 'in:dermatology_consultation,cosmetic_consultation,service,dental_consultation,pediatric_consultation,pediatric_service,package_bundle'],
