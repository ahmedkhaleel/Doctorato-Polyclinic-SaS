    ...
    <div class="space-y-8 pb-12">
        ...
        <div :ref="setSectionRef('recent')" data-section="recent"
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <tr v-for="(p, pi) in recentPatients" :key="p.id"
                            ...
                            <td class="py-3.5">
                                <Link :href="`/secretary/pediatric/patients/${p.id}`" class="font-semibold text-gray-800 hover:text-green-600 group-hover:text-green-600 transition-colors">
                                    {{ p.full_name }}
                                </Link>
                            </td>
            ...
            <div v-else class="flex flex-col items-center justify-center py-12 text-gray-300">
                ...
                <Link href="/secretary/pediatric/patients/create" class="mt-3 text-sm font-semibold text-green-600 hover:text-green-700 transition">
