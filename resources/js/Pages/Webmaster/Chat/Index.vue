...
defineOptions({ layout: WebmasterLayout });
    ...
    <div class="h-[calc(100vh-72px-57px)] flex rounded-2xl overflow-hidden bg-white shadow-sm border border-gray-200/80">
        ...
        >
            ...
            <div v-else class="flex-1 flex flex-col items-center justify-center bg-[#f8f9fb]">
                ...
                <p class="text-sm text-gray-400 mb-5">{{ isRtl ? 'اختر محادثة أو ابدأ محادثة جديدة' : 'Select a conversation or start a new one' }}</p>
