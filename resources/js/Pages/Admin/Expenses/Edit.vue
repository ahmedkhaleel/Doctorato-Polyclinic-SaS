    ...
    <AdminLayout :title="$t('a_edit_expense')">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-gray-800">{{ $t('a_edit_expense') }}</h1>
            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select v-model="form.expense_category_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-yellow-200 focus:border-transparent">
                            ...
                            <div>
                                ...
                                <select v-model="form.expense_item_id" :disabled="!form.expense_category_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-yellow-200 focus:border-transparent disabled:bg-gray-100">
