...
const navGroups = [
    ...
    },
    {
        ...
        items: [
            { labelEn: 'Dashboard',          labelAr: 'لوحة الجلدية والتجميل', href: '/admin/derma',                          icon: 'grid',      permission: null },
            { labelEn: 'Patients',           labelAr: 'المرضى',              href: '/admin/derma/patients',                 icon: 'heart',     permission: null },
            ...
            { labelEn: 'Derma Sessions',     labelAr: 'جلسات العلاج الجلدي', href: '/admin/derma/sessions',                 icon: 'activity',  permission: null },
            ...
            // ─── Shared ───────────────────────────────────────────
            { labelEn: 'Gallery',            labelAr: 'المعرض (قبل/بعد)',    href: '/admin/derma/gallery',                  icon: 'image',     permission: null },
