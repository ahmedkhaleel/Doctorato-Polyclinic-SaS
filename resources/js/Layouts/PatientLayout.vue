...
const navGroups = computed(() => [
    ...
    },
    {
        ...
        items: [
            ...
            { label: isRtl.value ? 'تصفح الخدمات' : 'Browse Services', href: lp('/services'), icon: 'sparkles' },
    ...
    {
        title: isRtl.value ? 'المكافآت' : 'Rewards',
        key: 'rewards',
        items: [
            { label: isRtl.value ? 'نقاط الولاء' : 'Loyalty Points', href: lp('/loyalty'),   icon: 'star' },
            { label: isRtl.value ? 'الإحالات'   : 'Referrals',      href: lp('/referrals'), icon: 'users' },
        ],
    },
    {
