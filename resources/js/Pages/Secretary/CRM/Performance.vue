            ...
            <Transition
                ...
                <div v-if="showGoalEditor" class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-4 sm:p-6" :dir="isRtl ? 'rtl' : 'ltr'">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <button @click="showGoalEditor = false" class="w-8 h-8 rounded-lg hover:bg-slate-100 flex items-center justify-center transition-colors" :aria-label="isRtl ? 'إغلاق' : 'Close'" :title="isRtl ? 'إغلاق' : 'Close'">
