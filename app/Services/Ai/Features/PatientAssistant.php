...
class PatientAssistant
{
    ...
    public function ask(string $question, string $sessionId, array $options = []): AiResult
    {
        ...
        $system = $this->systemPrompt($locale, $contextBlock);
        ...
        AiConversation::create(['session_id' => $sessionId, 'role' => 'assistant', 'content' => $result->text, 'patient_id' => $options['patient_id'] ?? null]);
