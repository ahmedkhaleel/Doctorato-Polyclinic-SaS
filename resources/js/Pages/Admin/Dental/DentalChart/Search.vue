        ...
        <div v-if="patients.length > 0" class="mb-8">
            ...
            <div class="space-y-2">
                <button v-for="patient in patients" :key="patient.id"
                    ...
                    class="w-full flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-slate-300 hover:shadow-md hover:bg-slate-50/30 transition-all group text-start"
                >
