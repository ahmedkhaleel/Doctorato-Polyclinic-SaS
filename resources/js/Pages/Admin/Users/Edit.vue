...
const lastSeen = computed(() => {
    if (!props.editUser.last_seen_at) return 'Never';
        ...
        <div>
            ...
            >
                <div v-if="showSuccess" class="mb-4 flex items-center gap-3 px-4 py-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                    ...
                    <p class="text-sm font-medium text-emerald-700">User updated successfully!</p>
                </div>
            </Transition>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-5">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-5 space-y-4">
                            <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Account Info</h3>
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-xs text-gray-500">Last seen</span>
                        ...
                        <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-5 space-y-3">
                            ...
                            <button type="button" @click="form.is_active = !form.is_active"
                                ...
                                <span class="font-medium">{{ form.is_active ? 'Deactivate Account' : 'Activate Account' }}</span>
                            </button>
                        </div>
                    </div>
