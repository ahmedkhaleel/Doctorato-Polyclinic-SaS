...
const typeConfig = {
    visit: { icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', color: 'from-[#1B365D] to-[#1B365D]', bg: 'bg-[#1B365D]', ring: 'ring-slate-100', badge: 'bg-slate-50 text-[#1B365D] border-slate-200', label_en: 'Visit', label_ar: 'زيارة' },
    ...
    prescription: { icon: 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z', color: 'from-[#C4A265] to-[#C4A265]', bg: 'bg-[#C4A265]', ring: 'ring-amber-100', badge: 'bg-amber-50 text-[#C4A265] border-amber-200', label_en: 'Prescription', label_ar: 'وصفة' },
    ...
    document: { icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', color: 'from-[#1B365D] to-[#1B365D]', bg: 'bg-[#1B365D]', ring: 'ring-slate-100', badge: 'bg-slate-50 text-[#1B365D] border-slate-200', label_en: 'Document', label_ar: 'مستند' },
    referral: { icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4', color: 'from-[#1B365D] to-[#1B365D]', bg: 'bg-[#1B365D]', ring: 'ring-slate-100', badge: 'bg-slate-50 text-[#1B365D] border-slate-200', label_en: 'Referral', label_ar: 'تحويل' },
}

const statusColors = {
    completed: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    paid: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    active: 'bg-slate-50 text-[#1B365D] border-slate-200',
    ...
    recorded: 'bg-slate-50 text-[#1B365D] border-slate-200',
    issued: 'bg-slate-50 text-[#1B365D] border-slate-200',
    partial: 'bg-amber-50 text-[#C4A265] border-amber-200',
}
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 shadow-xl mb-8 transition-all duration-700"
            ...
            <div class="relative p-4 md:p-6 sm:p-8">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        <h1 class="text-xl md:text-2xl sm:text-3xl font-bold text-white tracking-tight">{{ isRtl ? 'السجل الزمني الطبي' : 'Medical Timeline' }}</h1>
                    ...
                    <div class="text-end">
                        <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl px-5 py-3 border border-white/10">
                            ...
                            <div>
                                <p class="text-xl md:text-2xl font-bold text-white leading-none">{{ (timeline || []).length }}</p>
