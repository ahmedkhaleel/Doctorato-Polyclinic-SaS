    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="w-12 h-12 rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0 bg-gradient-to-r from-teal-500 to-cyan-500">
            ...
            <div class="flex items-center gap-2">
                <Link
                    ...
                    target="_blank"
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-white text-sm font-medium transition bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 shadow-sm"
                >
                ...
                <a
                    ...
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-medium transition border-green-300 text-green-700 hover:bg-green-50"
                >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
