    ...
    <AdminLayout :title="$t('a_message_details')">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-gray-800">{{ $t('a_message_details') }}</h1>
            ...
            <div class="max-w-4xl">
                <div class="bg-white rounded-lg shadow-sm p-6 space-y-5">
                    ...
                    <div class="flex space-x-3 pt-4 border-t border-gray-200 rtl:space-x-reverse">
                        <Link href="/admin/contact-messages" class="py-2.5 px-6 rounded-lg bg-gray-200 text-gray-700 text-sm font-medium hover:bg-gray-300 transition">
                            {{ $t('a_back_to_messages') }}
                        </Link>
                        <button
                            @click="deleteMessage"
                            class="py-2.5 px-6 rounded-lg bg-red-600 text-white text-sm font-medium hover:bg-red-700 transition"
                        >
                            {{ $t('a_delete_message') }}
                        </button>
                    </div>
