    ...
    <AdminLayout :title="$t('a_doctors')">
        <div class="doctors-page space-y-6">
            ...
            >
                <div class="stat-card bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-lg flex items-center justify-center bg-slate-50">
                ...
                <div class="stat-card bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xl md:text-2xl font-bold text-emerald-600">{{ stats.active }}</p>
                ...
                <div class="stat-card bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xl md:text-2xl font-bold text-gray-500">{{ stats.inactive }}</p>
                ...
                <div class="stat-card bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xl md:text-2xl font-bold text-amber-600">{{ stats.withLogin }}</p>
            ...
            >
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-50/50 border-b border-gray-100">
                                <th class="px-4 md:px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider" :class="isRtl ? 'text-right' : 'text-left'">{{ $t('a_doctor') || (isRtl ? 'الطبيب' : 'Doctor') }}</th>
                                <th class="px-4 md:px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider" :class="isRtl ? 'text-right' : 'text-left'">{{ $t('a_module') }}</th>
                                <th class="px-4 md:px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider" :class="isRtl ? 'text-right' : 'text-left'">{{ $t('a_specialization') }}</th>
                                <th class="px-4 md:px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">{{ $t('a_status') }}</th>
                                <th class="px-4 md:px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">{{ $t('a_order') }}</th>
                                <th class="px-4 md:px-6 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">{{ $t('a_actions') }}</th>
                            </tr>
                        </thead>
                                ...
                                <td class="px-4 md:px-6 py-4 text-center">
                                    ...
                                    >
                                        <span
                                            ...
                                            :class="doctor.status === 'active' ? 'bg-emerald-500' : 'bg-gray-400'"
                                        ></span>
                                ...
                                <td class="px-4 md:px-6 py-4 text-center">
                                    <div class="action-icons flex items-center justify-center gap-1">
                                        ...
                                        <Link
                                            v-if="can('doctors.view')"
                                            :href="`/admin/doctors/${doctor.id}`"
                                            class="action-btn w-8 h-8 rounded-lg flex items-center justify-center text-gray-400 hover:text-[#1B365D] hover:bg-slate-50 transition-all duration-200"
                                            :title="$t('a_view')"
                                        >
                ...
                <!-- Pagination -->
                <div v-if="doctors.links && doctors.links.length > 3" class="px-4 md:px-6 py-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
