...
<template>
    <WebmasterLayout title="Add Slide">
        <div class="space-y-6">
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    <!-- Image Upload -->
                    <div class="bg-white rounded-lg shadow-sm p-6 space-y-5">
                        <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wider">{{ $t('a_slide_image_required') }}</h3>
