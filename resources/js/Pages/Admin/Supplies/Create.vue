        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between animate-fade-in-up">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-gray-800">{{ $t('a_add_new_product') }}</h1>
                </div>
            </div>
                        ...
                        <div class="p-6 space-y-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input v-model="form.name_en" type="text" placeholder="e.g. Botox Allergan 100u" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200" />
                                ...
                                <div>
                                    ...
                                    <input v-model="form.name_ar" type="text" dir="rtl" placeholder="مثال: بوتكس ألرجان 100 وحدة" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200" />
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                <div>
                                    ...
                                    <input v-model="form.sku" type="text" placeholder="e.g. BTX-ALG-100" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-mono focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200" />
                                ...
                                <div>
                                    ...
                                    <input v-model="form.barcode" type="text" placeholder="e.g. 8901234567890" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-mono focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200" />
                            ...
                            <div>
                                ...
                                <textarea v-model="form.description" rows="3" placeholder="Product description, usage notes..." class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200 resize-none"></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6 space-y-5">
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                <div>
                                    ...
                                    <input v-model="form.quantity" type="number" min="0" step="0.01" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200" />
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-fade-in-up" style="animation-delay: 0.15s;">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input v-model="form.supplier" type="text" placeholder="Supplier name" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200" />
                            ...
                            <div>
                                ...
                                <input v-model="form.batch_number" type="text" placeholder="e.g. BT-2026-001" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-mono focus:ring-2 focus:ring-[#C4A265]/20 focus:border-[#C4A265] transition-all duration-200" />
                            </div>
                            <div>
                        ...
                        <div class="p-6">
                            <div class="rounded-xl border border-gray-100 p-4 space-y-3">
                                ...
                                <div class="flex items-center gap-2 text-xs">
                                    <span v-if="form.sku" class="font-mono text-[#C4A265]">{{ form.sku }}</span>
