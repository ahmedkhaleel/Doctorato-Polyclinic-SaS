...
> **حالة التنفيذ (2026-06-01):** ✅ المرحلة 0 + الموجات 1–5 **منفّذة ومُختبَرة ومرفوعة**.
> الإجمالي: 1118 اختبار Feature ناجح · 0 فشل · بناء فرونت-إند ناجح · بلا إيموجي · pint نظيف.
> كل شيء معطّل افتراضيًا (`ai_enabled=0`) حتى يُفعّله الأدمن من `/admin/ai/settings`.
