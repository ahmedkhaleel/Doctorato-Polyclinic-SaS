...
class StoreDoctorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Telemedicine
            'online_consultation_enabled' => 'nullable|boolean',
            'online_consultation_fee' => 'nullable|numeric|min:0',
            'online_session_duration_minutes' => 'nullable|integer|in:15,20,30,45,60',
            'online_consultation_bio_ar' => 'nullable|string|max:2000',
            'online_consultation_bio_en' => 'nullable|string|max:2000',
