...
const formProgress = computed(() => {
    const fields = [
        form.full_name, form.phone, form.gender,
        form.email, form.date_of_birth, form.nationality,
        form.address, form.occupation, form.blood_type,
    ];
...
<template>
    <AdminLayout :title="$t('a_add_patient')">
        <div class="space-y-6">
            <!-- Header -->
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <Link href="/admin/patients" class="flex items-center justify-center w-10 h-10 rounded-xl bg-white shadow-sm border border-gray-200 text-gray-500 hover:text-gray-800 hover:border-gray-300 transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
                    </Link>
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-gray-800">{{ $t('a_add_patient') }}</h1>
                        <p class="text-sm text-gray-500 mt-0.5">{{ $t('a_fill_patient_info') }}</p>
                    </div>
                </div>
                <!-- Progress -->
                <div class="hidden sm:flex items-center gap-3 bg-white rounded-xl shadow-sm border border-gray-200 px-4 py-2.5">
                    <div class="w-32 h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div class="h-full rounded-full transition-all duration-500 ease-out" :style="{ width: formProgress + '%', backgroundColor: '#C4A265' }"></div>
                    </div>
                    <span class="text-xs font-semibold text-gray-500">{{ formProgress }}%</span>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="p-4 md:p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.full_name" type="text" placeholder="Enter patient full name"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input v-model="form.phone" type="tel" dir="ltr" placeholder="01xxxxxxxxx" @input="filterPhoneInput('phone')"
                                            class="doctorato-input w-full pl-10 pr-4 py-2.5 border rounded-xl text-sm transition-all duration-200"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input v-model="form.phone2" type="tel" dir="ltr" placeholder="Optional" @input="filterPhoneInput('phone2')"
                                            class="doctorato-input w-full pl-10 pr-4 py-2.5 border rounded-xl text-sm transition-all duration-200"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input v-model="form.occupation" type="text" placeholder="e.g. Engineer"
                                            class="doctorato-input w-full pl-10 pr-4 py-2.5 border border-gray-200 bg-gray-50/50 rounded-xl text-sm focus:ring-2 focus:ring-[#C4A265]/30 focus:border-[#1B365D] focus:bg-white hover:border-gray-300 transition-all duration-200" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input v-model="form.emergency_contact_name" type="text" placeholder="Name of contact person"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input v-model="form.emergency_contact_phone" type="tel" dir="ltr" placeholder="01xxxxxxxxx" @input="filterPhoneInput('emergency_contact_phone')"
                                            class="doctorato-input w-full pl-10 pr-4 py-2.5 border rounded-xl text-sm transition-all duration-200"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            <div v-if="photoPreview" class="mb-4 text-center">
                                <div class="relative inline-block">
                                    <img :src="photoPreview" class="w-28 h-28 rounded-2xl object-cover shadow-md border-2 border-white" alt="" />
                                    <button type="button" @click="removePhoto" class="absolute -top-2 -right-2 w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center shadow-md hover:bg-red-600 transition" :aria-label="isRtl ? 'إغلاق' : 'Close'" :title="isRtl ? 'إغلاق' : 'Close'">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-4 md:p-6 space-y-3">
                            ...
                            <div v-if="form.referral_source === 'friend' || form.referral_source === 'doctor'" class="pt-2">
                                ...
                                <input v-model="form.referred_by" type="text" placeholder="Name of referrer"
                                    class="doctorato-input w-full px-4 py-2.5 border border-gray-200 bg-gray-50/50 rounded-xl text-sm focus:ring-2 focus:ring-[#C4A265]/30 focus:border-[#1B365D] focus:bg-white hover:border-gray-300 transition-all duration-200" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        <button
                            ...
                            {{ form.processing ? $t('a_creating') : $t('a_create_patient') }}
                        </button>
