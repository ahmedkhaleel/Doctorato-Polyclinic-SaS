                ...
                <div class="relative p-8 sm:p-10">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        >
                            ...
                            <div class="relative group">
                                ...
                                <button
                                 ...
                                 :aria-label="isRtl ? 'إظهار أو إخفاء كلمة المرور' : 'Show or hide password'" :title="isRtl ? 'إظهار أو إخفاء كلمة المرور' : 'Show or hide password'">
                        ...
                        >
                            ...
                            <Link href="/doctor/forgot-password" class="ml-auto rtl:mr-auto rtl:ml-0 text-sm text-[#C4A265]/70 hover:text-[#C4A265] transition-colors">
