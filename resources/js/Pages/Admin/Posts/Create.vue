                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <AiAssist feature="seo_content" label-ar="توليد مقال (إنجليزي)" label-en="Generate article (EN)"
                                :build-vars="() => ({ type: 'article', topic: form.title_en || form.title_ar })"
                                @insert="(t) => form.content_en = t" />
                        ...
                        <div>
                            ...
                            <AiAssist feature="seo_content" label-ar="توليد مقال (عربي)" label-en="Generate article (AR)"
                                :build-vars="() => ({ type: 'مقال', topic: form.title_ar || form.title_en })"
                                @insert="(t) => form.content_ar = t" />
