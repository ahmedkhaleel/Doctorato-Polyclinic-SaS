                ...
                <form @submit.prevent="submitPrescription" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input v-model="prescriptionForm.diagnosis" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm" :placeholder="$t('a_diagnosis')" />
                        </div>

                        <!-- Notes -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">{{ $t('a_notes') }}</label>
                            <input v-model="prescriptionForm.notes" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm" :placeholder="$t('a_optional_notes')" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div v-for="(item, idx) in prescriptionForm.items" :key="idx" class="flex flex-wrap gap-2 mb-3 items-start p-3 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <div class="w-28">
                                <input v-model="item.dosage" type="text" class="w-full px-3 py-1.5 border border-gray-300 rounded-lg text-sm" :placeholder="$t('a_dosage')" />
                            </div>
                            <div class="w-32">
                                <input v-model="item.frequency" type="text" class="w-full px-3 py-1.5 border border-gray-300 rounded-lg text-sm" :placeholder="$t('a_frequency')" />
                            </div>
                            <div class="w-24">
                                <input v-model="item.duration" type="text" class="w-full px-3 py-1.5 border border-gray-300 rounded-lg text-sm" :placeholder="$t('a_duration')" />
                            </div>
                            <div class="flex-1 min-w-[120px]">
                                <input v-model="item.instructions" type="text" class="w-full px-3 py-1.5 border border-gray-300 rounded-lg text-sm" :placeholder="$t('a_instructions')" />
                            </div>
                            <button
