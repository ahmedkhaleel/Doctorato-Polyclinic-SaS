...
class StoreBookingRequest extends FormRequest
{
    ...
    {
        $isService = in_array($this->input('booking_type'), ['service', 'dental_service']);

        return [
            'patient_id' => 'required|exists:patients,id',
            'booking_type' => 'required|in:dermatology_consultation,cosmetic_consultation,dental_consultation,dental_service,service',
