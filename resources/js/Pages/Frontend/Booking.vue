        ...
        <section class="relative py-16 lg:py-24 bk-section overflow-hidden">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div
                        v-if="flash.success"
                        class="mb-8 p-4 bg-emerald-50 border border-emerald-200 rounded-xl flex items-center gap-3"
                    >
                        ...
                        <p class="text-emerald-800 font-medium">{{ flash.success }}</p>
                    </div>
                </Transition>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div class="space-y-6" v-scroll-reveal="{ type: 'fade-left', delay: 150 }">
                        ...
                        <!-- WhatsApp CTA Card -->
                        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl shadow-lg p-6 border border-emerald-200 card-hover-lift">
                            <div class="text-center">
                                <div class="w-16 h-16 bg-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-green-500/30">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener"
                                    class="inline-flex items-center gap-2 w-full justify-center px-6 py-3 bg-emerald-500 text-white font-semibold rounded-xl hover:bg-emerald-600 transition-all duration-300 shadow-md hover:shadow-lg btn-shimmer"
                                >
