                ...
                <div v-if="isDental" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-4 sm:p-6 space-y-6">
                        ...
                        <div class="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                            ...
                            <Link href="/secretary/dental/treatment-plans" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-purple-700 bg-purple-50 hover:bg-purple-100 rounded-lg border border-purple-200 transition">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
                                {{ isRtl ? 'خطط العلاج' : 'Treatment Plans' }}
                            </Link>
                            <Link href="/secretary/dental/lab-orders" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-cyan-700 bg-cyan-50 hover:bg-cyan-100 rounded-lg border border-cyan-200 transition">
                ...
                <div v-if="visit.invoice" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-4 sm:p-6 space-y-3">
                        ...
                        <div v-if="visit.invoice.discount_amount != null && visit.invoice.discount_amount > 0" class="flex items-center justify-between text-sm">
                            ...
                            <span class="text-green-600">-{{ Number(visit.invoice.discount_amount).toFixed(2) }}</span>
                        </div>
                        ...
                        <div v-if="visit.invoice.status" class="flex items-center justify-between text-sm">
                            ...
                            <span
                                :class="{
                                    'bg-green-100 text-green-700': visit.invoice.status === 'paid',
                                    'bg-yellow-100 text-yellow-700': visit.invoice.status === 'pending' || visit.invoice.status === 'partial',
