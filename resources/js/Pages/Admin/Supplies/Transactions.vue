                ...
                <div v-if="showForm" class="p-6">
                    <form @submit.prevent="submit" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select v-model="form.transaction_type" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#1B365D]/20 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input v-model="form.quantity" type="number" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#1B365D]/20 focus:border-transparent" :placeholder="$t('a_use_negative_reduction')" />
                        ...
                        <div>
                            ...
                            <input v-model="form.unit_cost" type="number" step="0.01" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#1B365D]/20 focus:border-transparent" placeholder="0.00" />
                        ...
                        <div>
                            ...
                            <input v-model="form.notes" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#1B365D]/20 focus:border-transparent" :placeholder="$t('a_optional_notes')" />
                        </div>
