...
watch(search, (val) => {
    ...
    searchTimeout = setTimeout(() => {
        router.get('/webmaster/gallery', { search: val || undefined }, {
            preserveState: true,
            replace: true,
        });
    }, 400);
...
function deleteItem(id) {
    confirm(isRtl.value ? 'هل أنت متأكد من حذف هذا العنصر؟' : 'Are you sure you want to delete this gallery item?', () => {
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                >
                    <div class="aspect-square bg-gray-100 relative">
                        ...
                        <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-3">
                            <Link
                                ...
                                :href="`/webmaster/gallery/${item.id}/edit`"
                    ...
                    <div class="p-3">
                        <p class="text-sm font-medium text-gray-900 truncate">{{ item.caption_en || 'Untitled' }}</p>
