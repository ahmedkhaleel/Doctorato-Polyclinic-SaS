                    ...
                    >
                        ...
                        <div
                            ...
                            :class="{
                                ...
                                'bg-gray-50 text-gray-400 group-hover:bg-gray-100': !['new_booking','new_visit','booking_reminder','dental_lab_overdue','dental_appointment_reminder','dental_plan_due','dental_followup_reminder'].includes(item.type),
                            }"
                        >
