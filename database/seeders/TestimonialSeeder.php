    ...
    public function run(): void
    {
        ...
        $testimonials = [
            [
                ...
                'rating'         => 5,
                'review_ar'      => 'تجربة رائعة في عيادة أورا ديرما كلينك. الدكتورة أسماء حمدي متميزة جداً وشرحت لي كل خطوات العلاج بالتفصيل. النتائج كانت مذهلة وبشرتي أصبحت أفضل بكثير بعد جلسات علاج حب الشباب.',
                'review_en'      => 'An amazing experience at Aura Derma Clinic. Dr. Asmaa Hamdy is exceptional and explained every step of the treatment in detail. The results were stunning and my skin improved dramatically after the acne treatment sessions.',
                'photo'          => null,
                'video_url'      => null,
                'status'         => 'published',
                'display_order'  => 1,
            ...
            [
                ...
                'rating'         => 5,
                'review_ar'      => 'أنصح الجميع بزيارة عيادة أورا. الأجهزة حديثة جداً والفريق الطبي محترف ولطيف. أجريت جلسات ليزر لإزالة الشعر والنتائج فاقت توقعاتي. شكراً لكم.',
            ...
            [
                ...
                'rating'         => 4,
                'review_ar'      => 'تجربتي مع عيادة أورا كانت ممتازة. الموظفون ودودون والأطباء ذوو خبرة عالية. عملت جلسات تقشير كيميائي وبشرتي تحسنت بشكل ملحوظ. المكان مريح ونظيف.',
