                ...
                <div class="p-6 overflow-y-auto flex-1">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.date_of_birth" type="date" :class="['w-full ps-10 pe-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm transition-all duration-200 hover:border-gray-300 focus:ring-2 focus:border-transparent focus:bg-white', themeFocusRing]" />
                                </div>
                            </div>
                                    ...
                                    <div v-if="openDropdown === 'nationality'" class="absolute z-50 left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                                        <div class="p-2 border-b border-gray-100">
                                            <div class="relative">
                                                ...
                                                <input v-model="dropdownSearches['nationality']" type="text" :placeholder="$t('search') + '...'" :class="['w-full ps-8 pe-3 py-1.5 text-sm border border-gray-200 rounded-lg focus:ring-1 focus:border-transparent', themeRingSearch]" @click.stop />
                                            </div>
                                        </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.occupation" type="text" :class="['w-full ps-10 pe-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm transition-all duration-200 hover:border-gray-300 focus:ring-2 focus:border-transparent focus:bg-white', themeFocusRing]" :placeholder="$t('a_occupation_placeholder')" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.phone2" @input="filterPhone('phone2')" type="tel" :class="['w-full ps-10 pe-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm transition-all duration-200 hover:border-gray-300 focus:ring-2 focus:border-transparent focus:bg-white', themeFocusRing]" :placeholder="$t('a_optional_second_number')" dir="ltr" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.address" type="text" :class="['w-full ps-10 pe-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm transition-all duration-200 hover:border-gray-300 focus:ring-2 focus:border-transparent focus:bg-white', themeFocusRing]" :placeholder="$t('a_full_address')" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <Transition enter-active-class="transition duration-150" enter-from-class="opacity-0 -translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
                                    <div v-if="openDropdown === 'referral'" class="absolute z-50 left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                                        <div class="p-2 border-b border-gray-100">
                                            <div class="relative">
                                                <svg class="absolute start-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                                                <input v-model="dropdownSearches['referral']" type="text" :placeholder="$t('search') + '...'" :class="['w-full ps-8 pe-3 py-1.5 text-sm border border-gray-200 rounded-lg focus:ring-1 focus:border-transparent', themeRingSearch]" @click.stop />
                                            </div>
                                        </div>
                            ...
                            <div v-if="showReferredBy">
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.referred_by" type="text" :class="['w-full ps-10 pe-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm transition-all duration-200 hover:border-gray-300 focus:ring-2 focus:border-transparent focus:bg-white', themeFocusRing]" :placeholder="form.referral_source === 'doctor' ? $t('a_doctor_name') : $t('a_friend_name')" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea v-model="form.medical_notes" rows="3" :class="['w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm transition-all duration-200 hover:border-gray-300 focus:ring-2 focus:border-transparent focus:bg-white resize-none', themeFocusRing]" :placeholder="$t('a_medical_notes_placeholder')"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
