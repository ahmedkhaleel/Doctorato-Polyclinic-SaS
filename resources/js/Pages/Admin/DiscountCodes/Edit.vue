    ...
    <AdminLayout :title="$t('a_edit_discount_code')">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-gray-800">{{ $t('a_edit_discount_code') }}: {{ discountCode.code }}</h1>
                <span class="text-sm font-mono px-3 py-1 rounded-full bg-yellow-50" style="color: #C4A265;">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 space-y-3">
                        ...
                        <div class="text-center">
                            <span class="text-3xl font-bold" style="color: #C4A265;">{{ discountCode.used_count ?? 0 }}</span>
