                        ...
                        >
                            <td class="px-5 py-3.5">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold"
                                        :class="patient.gender === 'male' ? 'bg-slate-100 text-[#1B365D]' : 'bg-[#F5E7C8]/60 text-[#C4A265]'">
                            ...
                            <td class="px-5 py-3.5 text-center hidden xl:table-cell">
                                <span class="text-xs text-gray-600">
                                    <span class="font-semibold text-emerald-600">{{ patient.vaccines_given ?? 0 }}</span>
                                    /
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <Link
                                    ...
                                    class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 transition"
                                    @click.stop
                                >
