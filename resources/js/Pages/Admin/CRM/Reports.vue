                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div class="relative">
                                <input
                                    v-model="dateFrom"
                                    type="date"
                                    class="doctorato-input ltr:pl-9 rtl:pr-9 ltr:pr-3 rtl:pl-3 py-2.5 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#C4A265]/30 focus:border-[#C4A265] focus:bg-white transition-all duration-200"
                                />
