    ...
    <div class="border-t border-gray-200 bg-white p-4">
        ...
        <div class="flex items-end gap-2">
            ...
            <textarea
                ...
                rows="1"
                class="flex-1 resize-none border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-gray-200 transition-all max-h-32 overflow-y-auto"
