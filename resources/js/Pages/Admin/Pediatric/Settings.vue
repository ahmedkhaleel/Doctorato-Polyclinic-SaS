        ...
        <form @submit.prevent="submit" class="space-y-6 max-w-3xl">
            ...
            >
                ...
                <div class="p-5 space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <button type="button" @click="form.pediatric_sms_reminders_enabled = form.pediatric_sms_reminders_enabled === '1' ? '0' : '1'" class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200" :class="form.pediatric_sms_reminders_enabled === '1' ? 'bg-emerald-500' : 'bg-gray-300'">
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <label
                            ...
                            :class="form.pediatric_default_vaccine_schedule === opt.value ? 'border-emerald-500 bg-emerald-50 ring-2 ring-emerald-500/20' : 'border-gray-200 hover:border-gray-300'"
                        >
                            <input type="radio" v-model="form.pediatric_default_vaccine_schedule" :value="opt.value" class="sr-only" />
                            <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center transition-colors" :class="form.pediatric_default_vaccine_schedule === opt.value ? 'border-emerald-500' : 'border-gray-300'">
                                <div v-if="form.pediatric_default_vaccine_schedule === opt.value" class="w-2 h-2 rounded-full bg-emerald-500"></div>
                            </div>
                            <span class="text-sm font-medium" :class="form.pediatric_default_vaccine_schedule === opt.value ? 'text-emerald-700' : 'text-gray-600'">
                                {{ isRtl ? opt.ar : opt.en }}
                            </span>
                        </label>
                    </div>
            ...
            >
                <button
                    ...
                    class="px-6 py-3 rounded-xl text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 transition-all flex items-center gap-2 shadow-lg shadow-emerald-500/25"
                >
