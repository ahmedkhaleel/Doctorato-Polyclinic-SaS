...
const navGroups = [
    ...
    },
    {
        ...
        items: [
            ...
            { labelEn: 'Today Queue',      labelAr: 'مهام اليوم',        href: '/admin/crm/today',        icon: 'calendar2', permission: 'leads.view' },
    ...
    },
    {
        ...
        items: [
            ...
            { labelEn: 'Cases',        labelAr: 'الحالات',      href: '/admin/obgyn/cases',       icon: 'folder',    permission: 'obgyn.view' },
            { labelEn: 'Pregnancies',  labelAr: 'ملفات الحمل',  href: '/admin/obgyn/pregnancies', icon: 'heart',     permission: 'obgyn.view' },
            { labelEn: 'ANC Queue',    labelAr: 'متابعة الحمل', href: '/admin/obgyn/anc',         icon: 'calendar',  permission: 'obgyn.view' },
            { labelEn: 'Lab Tests',    labelAr: 'التحاليل',     href: '/admin/obgyn/labs',        icon: 'activity',  permission: 'obgyn.view' },
            { labelEn: 'Deliveries',   labelAr: 'الولادات',     href: '/admin/obgyn/deliveries',  icon: 'heart',     permission: 'obgyn.view' },
    ...
    {
        key: 'psychiatry', titleEn: 'Psychiatry', titleAr: 'الطب النفسي', moduleKey: 'psychiatry',
        color: '#7C3AED',
        featured: true,
        groupIcon: 'M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18',
        items: [
            { labelEn: 'Dashboard',  labelAr: 'لوحة التحكم', href: '/admin/psychiatry',           icon: 'grid',      permission: 'psychiatry.view' },
            { labelEn: 'Cases',      labelAr: 'الحالات',     href: '/admin/psychiatry/cases',      icon: 'folder',    permission: 'psychiatry.view' },
            { labelEn: 'Encounters', labelAr: 'اللقاءات',    href: '/admin/psychiatry/encounters', icon: 'clipboard', permission: 'psychiatry.view' },
            { labelEn: 'Outcomes',    labelAr: 'النتائج',         href: '/admin/psychiatry/outcomes',    icon: 'chartUp',    permission: 'psychiatry.view' },
            { labelEn: 'Medications', labelAr: 'الأدوية',         href: '/admin/psychiatry/medications', icon: 'medication', permission: 'psychiatry.view' },
            { labelEn: 'Risk Register', labelAr: 'سجل المخاطر',   href: '/admin/psychiatry/risk',        icon: 'shield',     permission: 'psychiatry.view_sensitive' },
            { labelEn: 'Controlled Rx', labelAr: 'المواد الخاضعة', href: '/admin/psychiatry/controlled', icon: 'pill',       permission: 'psychiatry.view_sensitive' },
            { labelEn: 'Courses',     labelAr: 'الدورات العلاجية', href: '/admin/psychiatry/courses',  icon: 'layers',    permission: 'psychiatry.view' },
            { labelEn: 'Reports',    labelAr: 'التقارير',    href: '/admin/psychiatry/reports',   icon: 'checklist', permission: 'psychiatry.view' },
            { labelEn: 'Settings',   labelAr: 'الإعدادات',   href: '/admin/psychiatry/settings',  icon: 'cog',       permission: 'psychiatry.view' },
        ],
    },
    {
        key: 'neurology', titleEn: 'Neurology', titleAr: 'طب الأعصاب', moduleKey: 'neurology',
        color: '#0EA5E9',
        featured: true,
        groupIcon: 'M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z',
        items: [
            { labelEn: 'Dashboard',  labelAr: 'لوحة التحكم', href: '/admin/neurology',            icon: 'grid',      permission: 'neurology.view' },
            { labelEn: 'Cases',      labelAr: 'الحالات',     href: '/admin/neurology/cases',       icon: 'folder',    permission: 'neurology.view' },
            { labelEn: 'Encounters', labelAr: 'اللقاءات',    href: '/admin/neurology/encounters',  icon: 'clipboard', permission: 'neurology.view' },
            { labelEn: 'Outcomes',    labelAr: 'النتائج',         href: '/admin/neurology/outcomes',    icon: 'chartUp',    permission: 'neurology.view' },
            { labelEn: 'Medications', labelAr: 'الأدوية',         href: '/admin/neurology/medications', icon: 'medication', permission: 'neurology.view' },
            { labelEn: 'Risk Register', labelAr: 'سجل المخاطر',   href: '/admin/neurology/risk',        icon: 'shield',     permission: 'neurology.view_sensitive' },
            { labelEn: 'Controlled Rx', labelAr: 'المواد الخاضعة', href: '/admin/neurology/controlled', icon: 'pill',       permission: 'neurology.view_sensitive' },
            { labelEn: 'Neuro Tools', labelAr: 'أدوات الأعصاب',  href: '/admin/neurology/neuro',      icon: 'activity',  permission: 'neurology.view' },
            { labelEn: 'Courses',     labelAr: 'الدورات العلاجية', href: '/admin/neurology/courses',   icon: 'layers',    permission: 'neurology.view' },
            { labelEn: 'Reports',    labelAr: 'التقارير',    href: '/admin/neurology/reports',    icon: 'checklist', permission: 'neurology.view' },
            { labelEn: 'Settings',   labelAr: 'الإعدادات',   href: '/admin/neurology/settings',   icon: 'cog',       permission: 'neurology.view' },
        ],
    },
    {
    ...
    {
        key: 'reports', titleEn: 'Reports', titleAr: 'التقارير',
        color: '#0EA5E9',
        groupIcon: 'M9 19v-6m4 6V5m4 14v-9M5 21h14',
        items: [
...
const PILLARS = [
    ...
    { key: 'reports', titleAr: 'التقارير والتحليلات', titleEn: 'Reports', icon: 'M9 19v-6m4 6V5m4 14v-9M5 21h14', groups: ['reports'] },
