...
/** Multi-branch B1 — visit events (clinical events that happen AT a branch). */
return new class extends Migration
{
    private array $tables = ['visits', 'visit_photos', 'prescriptions', 'prescription_items', 'medical_certificates'];
