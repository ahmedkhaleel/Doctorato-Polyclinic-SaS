...
const ruleTypes = [
    { value: 'source_based', label: 'Source Based', desc: 'Assign leads from a specific source to a user', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', color: 'bg-blue-50 text-blue-600 ring-1 ring-blue-200/60' },
    { value: 'round_robin', label: 'Round Robin', desc: 'Distribute leads evenly across team members', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15', color: 'bg-purple-50 text-purple-600 ring-1 ring-purple-200/60' },
...
function priorityColor(priority) {
    ...
    if (priority >= 20) return { bg: 'bg-blue-50', text: 'text-blue-700', ring: 'ring-blue-200/60', label: 'Medium' };
    ...
    <AdminLayout :title="$t('a_assignment_rules')">
        <div class="space-y-6">
            ...
            <div :class="mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 tracking-tight">{{ $t('a_assignment_rules') }}</h1>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="ltr:text-left rtl:text-right text-[10px] text-gray-400 uppercase tracking-wider border-b border-gray-100 bg-gray-50/60">
                                <th class="px-6 py-4 font-semibold">{{ $t('a_rule') }}</th>
                                <th class="px-6 py-4 font-semibold text-center">{{ $t('a_type') }}</th>
                                <th class="px-6 py-4 font-semibold">{{ $t('a_source') }}</th>
                                <th class="px-6 py-4 font-semibold">{{ $t('a_assign_to') }}</th>
                                <th class="px-6 py-4 font-semibold text-center">{{ $t('a_priority') }}</th>
            ...
            <div :class="mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
                ...
                <div class="h-1 bg-gradient-to-r from-blue-400 via-blue-300 to-blue-400"></div>
                <div class="p-6">
                    <div class="flex items-start gap-3">
