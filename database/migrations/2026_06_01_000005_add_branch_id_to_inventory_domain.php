...
/** Multi-branch B1 — inventory (per-branch stock; suppliers + categories stay shared). */
return new class extends Migration
{
    private array $tables = ['supplies', 'supply_transactions', 'purchase_orders', 'purchase_order_items'];
