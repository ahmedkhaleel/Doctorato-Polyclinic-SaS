                                ...
                                <td class="px-5 py-3.5">
                                    <div class="flex items-center gap-1 opacity-70 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <div v-if="can('leads.update')" class="relative">
                                            <button @click.stop="toggleQuickMenu(lead.id)" class="p-1.5 rounded-lg text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-all duration-200" :aria-label="isRtl ? 'خيارات' : 'Options'" :title="isRtl ? 'خيارات' : 'Options'">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <!-- Delete action -->
                                                    <template v-if="can('leads.delete')">
                                                        <div class="border-t border-gray-100 my-1.5"></div>
                                                        <button
                                                            @click="deleteLead(lead)"
                                                            class="w-full ltr:text-left rtl:text-right px-3 py-1.5 text-xs text-red-600 hover:bg-red-50 flex items-center gap-2 transition-colors font-semibold"
                                                        >
