...
watch(search, (val) => {
    ...
    searchTimeout = setTimeout(() => {
        router.get('/admin/posts', { search: val || undefined }, {
            preserveState: true,
            replace: true,
        });
    }, 400);
...
<template>
    <AdminLayout :title="$t('a_blog_posts')">
        <div class="space-y-6">
            <!-- Header -->
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="(post, i) in posts.data" :key="post.id" class="lst-row hover:bg-gray-50" :style="{ '--row-i': i }">
