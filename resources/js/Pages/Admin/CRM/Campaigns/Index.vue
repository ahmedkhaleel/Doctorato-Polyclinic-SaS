        ...
        <div class="space-y-6">
            ...
            >
                <div>
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">{{ $t('a_campaigns') }}</h1>
            ...
            >
                ...
                <div class="relative bg-white rounded-2xl shadow-sm p-5 border border-gray-100 text-center overflow-hidden group hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-800">{{ formatCurrency(stats.total_budget) }}</p>
                    <p class="text-[10px] text-gray-500 uppercase tracking-wider mt-1 font-semibold">{{ $t('a_total_budget') }}</p>
                </div>
                <!-- Total Leads -->
                <div class="relative bg-white rounded-2xl shadow-sm p-5 border border-gray-100 text-center overflow-hidden group hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    <div class="absolute top-0 ltr:left-0 rtl:right-0 ltr:right-0 rtl:left-0 h-1 bg-gradient-to-r from-slate-400 to-[#1B365D] rounded-t-2xl"></div>
                    <div class="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-slate-50 mb-3 group-hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-xl md:text-2xl font-bold text-[#1B365D]">{{ stats.total_leads }}</p>
                ...
                <div class="relative bg-white rounded-2xl shadow-sm p-5 border border-gray-100 text-center overflow-hidden group hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <p class="text-xl md:text-2xl font-bold text-emerald-600">{{ stats.total_conversions }}</p>
            ...
            >
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="ltr:text-left rtl:text-right text-[11px] text-gray-500 uppercase tracking-wider border-b border-gray-100 bg-gray-50/70">
                                <th class="px-4 md:px-6 py-4 font-semibold">{{ $t('a_campaign') }}</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            >
                                ...
                                <td class="px-5 py-4 text-center">
                                    <span class="inline-flex items-center justify-center min-w-[28px] px-2 py-0.5 text-xs font-bold rounded-full bg-slate-50 text-[#1B365D]">{{ c.leads_count }}</span>
                                </td>
                                <td class="px-5 py-4 text-center">
                                    <span class="inline-flex items-center justify-center min-w-[28px] px-2 py-0.5 text-xs font-bold rounded-full bg-emerald-50 text-emerald-700">{{ c.conversions_count }}</span>
                                </td>
                                <td class="px-5 py-4">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <Link
                                            ...
                                            class="group/btn relative inline-flex items-center justify-center w-8 h-8 rounded-lg text-gray-400 hover:text-[#1B365D] hover:bg-slate-50 transition-all duration-150"
                                        >
                ...
                <!-- Empty State -->
                <div v-if="!campaigns.data?.length" class="px-4 md:px-6 py-20 text-center">
                ...
                <!-- Pagination -->
                <div v-if="campaigns.last_page > 1" class="px-4 md:px-6 py-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
