...
const navGroups = [
    ...
    },
    {
        ...
        items: [
            { labelEn: 'Derma Dashboard',    labelAr: 'لوحة الجلدية',       href: '/admin/derma',                          icon: 'grid',      permission: null },
            { labelEn: 'Derma Patients',     labelAr: 'مرضى الجلدية',       href: '/admin/derma/patients',                 icon: 'heart',     permission: null },
            { labelEn: 'Visits',             labelAr: 'الزيارات',           href: '/admin/derma/visits',                   icon: 'clipboard', permission: null },
            { labelEn: 'Skin Conditions',    labelAr: 'الحالات الجلدية',    href: '/admin/derma/conditions',               icon: 'sparkles',  permission: null },
            { labelEn: 'Treatment Sessions', labelAr: 'جلسات العلاج',       href: '/admin/derma/sessions',                 icon: 'activity',  permission: null },
            { labelEn: 'Gallery',            labelAr: 'المعرض',             href: '/admin/derma/gallery',                  icon: 'image',     permission: null },
            { labelEn: 'Rx Templates',       labelAr: 'قوالب الوصفات',      href: '/admin/derma/prescription-templates',   icon: 'file-text', permission: null },
            { labelEn: 'Settings',           labelAr: 'الإعدادات',          href: '/admin/derma/settings',                 icon: 'cog',       permission: null },
        ],
    },
    {
        ...
        items: [
            { labelEn: 'Cosmetic Dashboard', labelAr: 'لوحة التجميل',       href: '/admin/cosmetic',                 icon: 'grid',      permission: null },
            { labelEn: 'Cosmetic Patients',  labelAr: 'مرضى التجميل',        href: '/admin/cosmetic/patients',        icon: 'heart',     permission: null },
            { labelEn: 'Procedures',         labelAr: 'الإجراءات',           href: '/admin/cosmetic/procedures',      icon: 'sparkles',  permission: null },
            { labelEn: 'Packages',           labelAr: 'باقات الجلسات',       href: '/admin/cosmetic/packages',        icon: 'layers',    permission: null },
            { labelEn: 'Sessions',           labelAr: 'جلسات العملاء',       href: '/admin/cosmetic/sessions',        icon: 'activity',  permission: null },
            { labelEn: 'Gallery',            labelAr: 'المعرض',              href: '/admin/cosmetic/gallery',         icon: 'image',     permission: null },
            { labelEn: 'Consent Forms',      labelAr: 'نماذج الموافقة',      href: '/admin/cosmetic/consents',        icon: 'document',  permission: null },
            { labelEn: 'Settings',           labelAr: 'الإعدادات',           href: '/admin/cosmetic/settings',        icon: 'cog',       permission: null },
        ],
    },
    {
