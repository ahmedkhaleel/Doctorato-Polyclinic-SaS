...
function submit() {
    form.post(`/webmaster/posts/${props.post.id}`, {
        forceFormData: true,
    });
}
</script>
...
<template>
    <WebmasterLayout title="Edit Post">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-gray-800">{{ $t('a_edit_post') }}</h1>
                <Link href="/webmaster/posts" class="text-sm text-gray-500 hover:text-gray-700">{{ $t('a_back_to_posts') }}</Link>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 space-y-5">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_featured" class="ltr:ml-2 rtl:mr-2 text-sm text-gray-700">Featured Post</label>
                        </div>
                    </div>
                    ...
                    <div class="flex ltr:space-x-3 rtl:space-x-reverse rtl:space-x-3">
                        ...
                        <Link href="/webmaster/posts" class="px-4 py-2.5 rounded-lg bg-gray-200 text-gray-700 text-sm font-medium hover:bg-gray-300 transition">{{ $t('a_cancel') }}</Link>
                    </div>
                </div>
            </form>
        </div>
