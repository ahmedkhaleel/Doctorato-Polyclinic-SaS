...
// Per-specialty clinical panel payload (each panel reads the keys it needs)
const specialtyExtras = computed(() => ({
    dentalChart: props.dentalChart,
    dentalXrays: props.dentalXrays,
    allTeeth: props.allTeeth,
    treatmentTypes: props.treatmentTypes,
    perioSummary: props.perioSummary,
    ...
    <div class="space-y-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Per-specialty clinical panel (dental / derma / … — lazy-loaded) -->
                <SpecialtyPanel :visit="visit" :is-rtl="isRtl" :mounted="mounted" :extras="specialtyExtras" />
            </div>
