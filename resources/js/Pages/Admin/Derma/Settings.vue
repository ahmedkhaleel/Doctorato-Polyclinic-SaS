        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1B365D] via-[#1B365D] to-[#0F2444] shadow-xl">
            ...
            <div class="relative p-4 md:p-7 flex items-start gap-3 md:gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <h1 class="text-xl md:text-3xl font-extrabold text-white tracking-tight">{{ t('Derma Settings', 'إعدادات الجلدية') }}</h1>
                    <p class="text-xs md:text-sm text-white/70 mt-1">{{ t('Configure dermatology module', 'تكوين قسم الجلدية') }}</p>
                </div>
            </div>
        </div>
