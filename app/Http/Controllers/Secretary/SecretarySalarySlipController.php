...
class SecretarySalarySlipController extends BaseSecretaryController
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Secretary/MySalarySlips/Index', [
            'slips' => $slips,
        ]);
    }
    ...
    public function show(Request $request, SalarySlip $salarySlip): Response
    {
        ...
        return Inertia::render('Secretary/MySalarySlips/Show', [
            'slip' => $salarySlip,
        ]);
    }
}
