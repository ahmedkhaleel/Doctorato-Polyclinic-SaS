...
Route::middleware('admin.auth')->group(function () {
    ...
    Route::post('/pediatric/vaccinations', [\App\Http\Controllers\Admin\AdminPediatricController::class, 'storeVaccination'])->name('admin.pediatric.vaccinations.store')->middleware(['module:pediatric', 'permission:pediatric.view']);
    Route::post('/pediatric/patients/{patient}/vaccinations/initialize', [\App\Http\Controllers\Admin\AdminPediatricController::class, 'initializeVaccinations'])->name('admin.pediatric.vaccinations.initialize')->middleware(['module:pediatric', 'permission:pediatric.view']);
    Route::post('/pediatric/vaccinations/{vaccination}/status', [\App\Http\Controllers\Admin\AdminPediatricController::class, 'updateVaccinationStatus'])->name('admin.pediatric.vaccinations.status')->middleware(['module:pediatric', 'permission:pediatric.view']);
