                        ...
                        <div class="p-6">
                            <div v-if="photoPreview" class="mb-4 text-center">
                                <div class="relative inline-block">
                                    ...
                                    <button type="button" @click="removePhoto" class="absolute -top-2 -right-2 w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center shadow-md hover:bg-red-600 transition">
