...
class SalarySlipsExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    protected $month;
    protected $year;
    protected $status;

    public function __construct(?int $month = null, ?int $year = null, ?string $status = null)
    {
        $this->month = $month;
        $this->year = $year;
        $this->status = $status;
    ...
    {
        return [
            'Slip #', 'Employee', 'Department', 'Month', 'Year', 'Status',
