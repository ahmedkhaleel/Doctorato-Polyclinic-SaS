                ...
                <div class="flex flex-wrap gap-3 items-center">
                    <div class="relative flex-1 min-w-[200px]">
                        ...
                        <input v-model="search" type="text" :placeholder="isRtl ? 'بحث بالمريض أو العنوان...' : 'Search patient or title...'"
                            class="doctorato-input w-full ltr:pl-10 rtl:pr-10 pr-4 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-200 focus:border-slate-300 transition" />
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center gap-1.5 mt-3 pt-3 border-t border-gray-100">
                            ...
                            <button @click="toggleFeatured(comp.id)"
                                class="p-1.5 rounded-lg transition"
                                :class="comp.is_featured ? 'text-amber-500 bg-amber-50 hover:bg-amber-100' : 'text-gray-400 bg-gray-50 hover:bg-gray-100'" :aria-label="isRtl ? 'تمييز' : 'Feature'" :title="isRtl ? 'تمييز' : 'Feature'">
                            ...
                            <button @click="confirmDelete(comp.id)" class="p-1.5 text-gray-400 bg-gray-50 rounded-lg hover:bg-red-50 hover:text-red-500 transition" :aria-label="isRtl ? 'حذف' : 'Delete'" :title="isRtl ? 'حذف' : 'Delete'">
