    ...
    <div :dir="isRtl ? 'rtl' : 'ltr'" class="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364]">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold tracking-widest text-teal-400">AURA</h1>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="secretary@aura-derma.com"
                        />
            ...
            <p class="text-center text-white/20 text-xs mt-6">&copy; {{ new Date().getFullYear() }} {{ isRtl ? 'عيادة أورا ديرما &middot; بوابة السكرتارية' : 'AURA Derma Clinic &middot; Secretary Portal' }}</p>
        </div>
    </div>
</template>
