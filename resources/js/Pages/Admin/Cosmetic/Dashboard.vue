...
<template>
    <div class="space-y-6 pb-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            ]" :key="s.label" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="text-lg font-semibold mb-4 text-gray-800">{{ t('Top Procedures', 'أعلى الإجراءات') }}</h3>
                <div class="space-y-2">
                    ...
                    <p v-if="!topProcedures?.length" class="text-sm text-gray-400 text-center py-6">{{ t('No data yet', 'لا توجد بيانات') }}</p>
                </div>
            </div>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="text-lg font-semibold mb-4 text-gray-800">{{ t('Category Breakdown', 'تصنيف الإجراءات') }}</h3>
                <div class="space-y-2">
