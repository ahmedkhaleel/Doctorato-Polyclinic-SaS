                    ...
                    <div :data-status="status" class="px-3 py-3 space-y-2.5 min-h-[120px] max-h-[65vh] overflow-y-auto" style="scrollbar-width: thin;">
                        ...
                        >
                            ...
                            <p v-if="lead.phone" class="text-xs text-gray-500 mb-2.5 flex items-center gap-1.5">
                                ...
                                <WhatsAppLink :phone="lead.phone" size="w-3.5 h-3.5" />
                            </p>
                ...
                <div v-if="drawerOpen" class="fixed top-0 ltr:right-0 rtl:left-0 h-full w-full max-w-[480px] bg-white shadow-2xl z-[70] flex flex-col">
                    ...
                    <div class="flex items-center justify-between px-4 md:px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button @click="closeDrawer" class="p-2 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors" :aria-label="isRtl ? 'إغلاق' : 'Close'" :title="isRtl ? 'إغلاق' : 'Close'">
